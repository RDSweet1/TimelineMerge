...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*complete-story" workflow="{project-root}/bmad/bmm/workflows/4-implementation/complete-story/workflow.yaml">Approve last story, combine next story's workflows</item>
